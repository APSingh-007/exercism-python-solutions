...
def categorize_dish(dish_name: str, dish_ingredients: list) -> str:
    ...
    """
    dish_types: list = ["VEGAN", "VEGETARIAN", "KETO", "PALEO", "OMNIVORE"]
    for index, ingredients in enumerate([VEGAN, VEGETARIAN, KETO, PALEO, OMNIVORE]):
        if set(dish_ingredients).issubset(ingredients):
            return f"{dish_name}: {dish_types[index]}"
